...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='poolpiid',
            name='vendors',
            field=models.ForeignKey(to='vendors.Vendors'),
        ...
        migrations.AddField(
            model_name='vendors',
            name='pools',
            field=models.ManyToManyField(through='vendors.PoolPIID', to='vendors.Pool'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='vendors',
            name='setasides',
            field=models.ManyToManyField(null=True, to='vendors.SetAside'),
            preserve_default=True,
        ),
    ]
